    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">{t("staff.stationInfo")}</h3>            <div className="flex items-center space-x-3">
              <MapPin className="w-5 h-5 text-gray-400" />
              <span className="text-gray-700">
                {t("staff.station")} {user.stationId ? `ID: ${String(user.stationId).substring(0, 8)}...` : 'N/A'} - Quận 1, TP.HCM
              </span>
            </div>
